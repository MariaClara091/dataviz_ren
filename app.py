...
# =============================================================================
# COMENTARIOS SOBRE LA DISTRIBUCIÓN DE CASOS
# =============================================================================

# Las principales regiones de concentración fueron:
# 1. Bogotá D.C. con 65,908 casos, siendo el 40% del total
# 2. Departamento de Antioquia con 39,941 casos, siendo el 15% del total  
# 3. Valle del Cauca con 27,108 casos, siendo el 7% del total
# 4. Atlántico con 17,058 casos
# 5. Córdoba con 15,566 casos
#
# Se ven desigualdades marcadas pues hubo una brecha de 12,600 de 1 entre el departamento con más casos, 
# como Bogotá con 65,908, y los menos afectados como los departamentos amazónicos con aprox. 5 casos.
#
# Algunos factores que podrían explicar estas diferencias puede ser:
# - Conectividad aérea y terrestre
# - Aislamiento natural de periferias
# - Acceso a servicios de salud
# - La gran densidad en centros urbanos
# - Dificultad para distanciamiento social en áreas marginales. 
#
# Gracias a la georreferenciación se permitió que se visualizaran las desigualdades evidentes en tablas del top 10. 
# Tambien a identificar patrones espaciales de la transmisión del Covid 19 en las áreas urbanas, y así contextualizar 

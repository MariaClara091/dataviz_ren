...
# =============================================================================
# DATOS CON GEOJSON DE COLOMBIA
# =============================================================================

def cargar_datos_con_geojson():
    """Función para crear datos con GeoJSON de departamentos de Colombia"""
    
    # Datos de departamentos con casos reales basados en tu información
    datos_departamentos = [
...
# Cargar datos
df_datos = cargar_datos_con_geojson()

# GeoJSON simplificado para Colombia (usaremos uno público)
# En una implementación real, deberías usar un GeoJSON oficial de Colombia
...
def actualizar_dashboard(tipo_visualizacion):
    ...
    if tipo_visualizacion == 'casos':
        ...
        color_bar = '#1f77b4'
        hover_template = '<b>%{location}</b><br>Casos: %{z:,}<br>Incidencia: %{customdata[0]:.1f}'
    else:
        columna = 'incidencia'
        ...
        color_bar = '#d62728'
        hover_template = '<b>%{location}</b><br>Incidencia: %{z:.1f}<br>Casos: %{customdata[0]:,}'
    
    # 1. MAPA COROPLÉTICO CON GEOJSON
    # Nota: En producción, usa un GeoJSON oficial de Colombia
    fig_mapa = px.choropleth(
        df_datos,
        geojson=colombia_geojson_url,
